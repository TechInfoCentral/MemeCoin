...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>AstralFuel - New Meme, Big Dreams</title>
      </Head>
      <div className="flex flex-col gap-16">
        <div className="relative grid h-full grid-cols-2 gap-10 p-4 pt-40 pb-32 my-auto overflow-hidden xl:px-8 xs:grid-cols-1">
          <div className="z-10 flex flex-col gap-12">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2 px-4 border-2 border-orange-500 rounded-full text-neutral-200 max-w-max">
                ...
                <span className="text-sm font-semibold">Live on Base</span>
              </div>
              <h1 className="flex flex-col gap-6 font-semibold text-7xl sm:text-6xl xs:text-6xl">
                <span className="text-white">New meme, big dreams</span>
                {/* <span className="text-white">Big dream.</span> */}
              </h1>
              <p className="text-gray-300">Explore the crypto world. Join the community</p>
            </div>
            <button className="flex items-center gap-2 p-4 px-6 transition-all bg-orange-500 max-w-max hover:scale-105 rounded-xl">
              <span className="font-semibold">Buy $ASTRALFUEL</span>
            </button>
          </div>
          <div className="relative flex flex-col items-center justify-center gap-2">
            ...
            <Image className="z-10" src="/images/3d-space-rocket.png" width={300} height={300} />
